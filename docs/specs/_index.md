...
| 06 | [word-reference-lines](06-word-reference-lines.md) _(index)_ | Per-word baseline / x-height / cap-height / ascender / descender reference geometry (planning) | Anything depending on within-line vertical reference lines: drop caps, footnote anchors, small caps detection, bottom-crop |
