...
def R(
    L: int, T: int, R_: int, B: int, type_: RegionType = RegionType.text
) -> LayoutRegion:
    return LayoutRegion(type=type_, L=L, R=R_, T=T, B=B, confidence=0.9)


class TestIoU:
    def test_zero_when_disjoint(self) -> None:
    ...
    def test_identical_zero_area_returns_zero_by_convention(self) -> None:
...
class TestContains:
    ...
    def test_outside_one_edge(self) -> None:
        outer = R(0, 0, 100, 100)
...
class TestHorizontalOverlap:
    def test_same_columns(self) -> None:
        a = R(100, 0, 300, 200)
        b = R(100, 250, 300, 290)
...
class TestCaptionForFigure:
    def test_caption_just_below(self) -> None:
    ...
    def test_caption_above_ignored_by_default(self) -> None:
    ...
    def test_caption_above_found_when_above_true(self) -> None:
    ...
    def test_caption_above_too_far_when_above_true(self) -> None:
    ...
    def test_caption_below_preferred_over_caption_above(self) -> None:
...
class TestReadingOrder:
    def test_top_then_left(self) -> None:
        a = R(100, 0, 200, 50)
        b = R(0, 0, 80, 50)
        c = R(0, 100, 200, 200)
        assert region_reading_order([c, a, b]) == [b, a, c]

    def test_multi_column_returns_column_first_order(self) -> None:
    ...
    def test_single_column_no_warn(self) -> None:
    ...
    def test_full_width_region_does_not_split_columns(self) -> None:
    ...
    def test_preserves_all_regions(self) -> None:
