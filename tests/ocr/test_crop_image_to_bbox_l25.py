...
def test_expected_exception_types_still_swallowed(caplog, exc_type):
...
def test_happy_path_still_returns_array():
...
def test_none_element_or_image_short_circuits_to_none():
