...
class TestLabelNormalizationCoverage:
    def test_normalize_scope_none_returns_whole(self) -> None:
        """normalize_text_style_label_scope(None) → 'whole' (line 62)."""
        result = normalize_text_style_label_scope(None)
        assert result == "whole"

    def test_normalize_scopes_empty_labels_none_scopes(self) -> None:
    ...
    def test_normalize_scopes_empty_labels_empty_scopes(self) -> None:
...
class TestWordApplyStyleScope:
    def test_apply_scope_adds_new_style(self) -> None:
    ...
    def test_apply_scope_updates_existing_style(self) -> None:
...
class TestWordNormalizedStyleLabels:
    def test_ignores_invalid_label_returns_regular(self) -> None:
...
class TestWordResolveStyleLabelAliasLoop:
    def test_alias_resolves_primary_name(self) -> None:
    ...
    def test_alias_loop_returns_via_alias(self) -> None:
...
class TestWordResolveWordComponentAliasLoop:
    def test_component_resolves_primary_name(self) -> None:
    ...
    def test_component_via_alias(self) -> None:
...
class TestWordExpandBbox:
    def test_expand_bbox_pixel_coords(self) -> None:
    ...
    def test_expand_bbox_normalized_coords(self) -> None:
    ...
    def test_expand_bbox_no_bbox_returns_false(self) -> None:
    ...
    def test_expand_bbox_normalized_no_page_dims_returns_false(self) -> None:
