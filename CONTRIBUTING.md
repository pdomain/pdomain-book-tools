...
- Includes: Ruff linting/formatting, trailing whitespace removal, YAML/JSON
  validation
...
We provide a comprehensive Makefile for all development tasks. Run
...
**💡 Pro tip**: Use `make reset` for most environment issues, `make reset-full`
only when everything is broken!
