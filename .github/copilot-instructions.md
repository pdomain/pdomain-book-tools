...
- Treat `AGENTS.md` as canonical for workflow, architecture, validation, and
...
- For tests in VS Code, use Make targets or `uv run pytest ...` from
...
- For code generation, setup/configuration, and library/API references, use
  Context7 MCP tools.
