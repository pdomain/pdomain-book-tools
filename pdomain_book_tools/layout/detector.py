...
without any ML dep; it's the stepping-stone the pdomain-prep-for-pgdp spec 05
originally drafted.
"""
...
class ContourDetector:
    ...
    illustration extractor in pdomain-prep-for-pgdp may post-classify some as
    ``decoration`` based on size/position — see the
    "Decoration-vs-figure post-classification" item in
    ``pdomain-book-tools/docs/ROADMAP.md``.
    """
