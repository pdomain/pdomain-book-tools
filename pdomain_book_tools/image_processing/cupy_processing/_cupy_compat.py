...
Importing any module under ``pdomain_book_tools.image_processing.cupy_processing``
...
GPU_EXTRA_INSTALL_HINT = (
    "CuPy/CUDA is required for pdomain_book_tools GPU functionality. "
    "Install with: pip install 'pdomain-book-tools[gpu]' "
...
try:
    import cupy as cp  # CuPy is an optional GPU dep (not in lockfile).
