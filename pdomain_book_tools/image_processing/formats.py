...
``pdomain-book-tools``; if they are missing the import falls back gracefully
...
# broken install of pdomain-book-tools does not blow up at import time — the
...
# on a stock install of pdomain-book-tools. HEIF/HEIC and AVIF support is wired
...
SUPPORTED_IMAGE_SUFFIXES: frozenset[str] = frozenset(
    {
        # PNG / JPEG / TIFF / BMP / WebP — the historical pdomain-ocr-cli set.
        ".png",
        ".jpg",
        ".jpeg",
        ".tif",
