...
:mod:`pdomain_book_tools.hf.models` and are re-exported from
:mod:`pdomain_book_tools.hf`.
"""
...
def hf_download(
    ...
    ``pdomain_book_tools.hf.download`` logger. On a warm cache, no extra output.
