...
class Word:
    ...
    # has touched this word. See pdomain_book_tools/ocr/review.py.
    ...
    def refine_bbox(self, page_image: ndarray | None, padding_px: int = 1) -> bool:
        ...
        :func:`pdomain_book_tools.ocr.image_utilities.refine_word_bbox`; call
        ...
        from pdomain_book_tools.ocr.image_utilities import refine_word_bbox
    ...
    def crop_bottom(self, img_ndarray: ndarray | None) -> None:
        ...
        The implementation lives in
        :func:`pdomain_book_tools.ocr.image_utilities.crop_word_bottom`; call
        that directly in new code. This wrapper is preserved for
        backward compatibility (R-01).
        """
        from pdomain_book_tools.ocr.image_utilities import crop_word_bottom
    ...
    def crop_top(self, img_ndarray: ndarray | None) -> None:
        ...
        The implementation lives in
        :func:`pdomain_book_tools.ocr.image_utilities.crop_word_top`; call
        that directly in new code. This wrapper is preserved for
        backward compatibility (R-01).
        """
        from pdomain_book_tools.ocr.image_utilities import crop_word_top
