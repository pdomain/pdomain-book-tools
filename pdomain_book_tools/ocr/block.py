...
class Block:
    ...
    def __init__(
        ...
        # when block_category == LINE). See pdomain_book_tools/ocr/review.py.
...
def purge_words_from_blocks(blocks: list[Block], targets: set[int]) -> None:
    ...
    :mod:`pdomain_book_tools.ocr.reorganize_page_utils` (geometry pipeline).
    ...
    pipeline copy existed to avoid pulling :mod:`pdomain_book_tools.layout`
